...
/***/ "webpack/container/reference/rileysRemoteMfe":
/*!********************************************************************!*\
  !*** external "rileysRemote@http://localhost:4000/remoteEntry.js" ***!
  \********************************************************************/
/***/ (function(module, __unused_webpack_exports, __webpack_require__) {

eval("var __webpack_error__ = new Error();\nmodule.exports = new Promise(function(resolve, reject) {\n\tif(typeof rileysRemote !== \"undefined\") return resolve();\n\t__webpack_require__.l(\"http://localhost:4000/remoteEntry.js\", function(event) {\n\t\tif(typeof rileysRemote !== \"undefined\") return resolve();\n\t\tvar errorType = event && (event.type === 'load' ? 'missing' : event.type);\n\t\tvar realSrc = event && event.target && event.target.src;\n\t\t__webpack_error__.message = 'Loading script failed.\\n(' + errorType + ': ' + realSrc + ')';\n\t\t__webpack_error__.name = 'ScriptExternalLoadError';\n\t\t__webpack_error__.type = errorType;\n\t\t__webpack_error__.request = realSrc;\n\t\treject(__webpack_error__);\n\t}, \"rileysRemote\");\n}).then(function() { return rileysRemote; });\n\n//# sourceURL=webpack://client/external_%22rileysRemote@http://localhost:4000/remoteEntry.js%22?");
...
/******/ 	!function() {
/******/ 		var chunkMapping = {
/******/ 			"webpack_container_remote_rileysRemoteMfe_App": [
/******/ 				"webpack/container/remote/rileysRemoteMfe/App"
/******/ 			]
/******/ 		};
...
/******/ 					initExternal("webpack/container/reference/rileysRemoteMfe");
/******/ 				}
/******/ 				break;
/******/ 			}
...
/******/ 					} else {
/******/ 						if(!/^webpack_(sharing_consume_default_(react_react|web\-vitals_web\-vitals)|container_remote_rileysRemoteMfe_App)$/.test(chunkId)) {
